...
func main() {
	...
	outFile := flag.Arg(0)
	if outFile == "" {
		fmt.Println("missing ouput file")
		os.Exit(1)
	}
...
func printTable(w io.Writer) {
	...
	fmt.Fprintln(w)
	fmt.Fprintln(w, "// Code generated by typesetting-utils/generators/langs/gen.go. DO NOT EDIT.")
	fmt.Fprintln(w)
...
func printSubtagMatches(w io.Writer, subtag string, newLine bool) {
	...
	fmt.Fprintf(w, "subtagMatches (langStr, %q)", subtag)
}
