...
<p align="center">
  ...
  <img alt="Latest public release v0.2.9" src="https://img.shields.io/badge/Latest-v0.2.9-2ea043?style=for-the-badge">
...
- Current public release: [`v0.2.9`](https://github.com/Pumnn1ayLee/PECL/releases/tag/v0.2.9)
- Release notes: [docs/releases/v0.2.9.md](./docs/releases/v0.2.9.md)
- Recommended package: `PECL_0.2.9_x64-setup.exe`
...
If you run into issues while using PECL, please open an Issue in this repository with:
...
PECL is continuing to improve in these areas:
